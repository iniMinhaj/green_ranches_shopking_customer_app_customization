class ApiList {
  ...
  static const productCategory =
      "$baseUrl/api/frontend/product-category?status=5";
  ...
  static String promotionWiseProduct(
          {required String slug,
          required int paginate,
          required int page,
          required int perPage}) =>
      "$baseUrl/api/frontend/promotion/products/$slug?paginate=$paginate&page=$page&per_page=$perPage&active=5";
  static const productSection = "$baseUrl/api/frontend/product-section";
  static const slider = "$baseUrl/api/frontend/slider?status=5";
